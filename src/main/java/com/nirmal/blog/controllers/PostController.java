...
import com.nirmal.blog.services.FileService;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPosts(
			...
			@RequestParam(value = "pageValue", defaultValue = AppConstants.PAGE_SIZE, required = false) Integer pageValue,
			@RequestParam(value = "sortBy", defaultValue = AppConstants.SORT_BY, required = false) String sortBy,
			@RequestParam(value = "sortDirection", defaultValue = AppConstants.SORT_DIRECTION, required = false) String sortDirection) {
		logger.info("Method : getAllPosts starts");
		PostResponse allPost = this.postService.getAllPost(pageNumber, pageValue, sortBy, sortDirection);
	...
	// file upload for post controller
